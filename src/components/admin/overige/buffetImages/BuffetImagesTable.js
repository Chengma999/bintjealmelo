...
const BuffetImagesTable = (props) => {
  const { buffetImages, updateBuffetImage, deleteBuffetImage } = props;
  buffetImages.sort((a, b) => a.sort_number - b.sort_number);
    ...
    <div className={styles.table}>
      <Form form={form} component={false}>
        <Table
          ...
          bordered
          dataSource={buffetImages.map((ele, i) => ({ key: i, ...ele }))}
...
export default BuffetImagesTable;
